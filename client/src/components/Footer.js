      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={6} sm={6} md={3} sx={{ textAlign: 'center' , mt:{sm:'40px',xs:'20px'}}}>
          <Box sx={{  paddingLeft:{sm:'60px',xs:"30px"},marginBottom: '20px' , textAlign:'start'}}>
            ...
            <Typography variant='body1' sx={{fontSize:{xs:'14px',sm:'16px'}}} mb={1}><Link href="/contact" sx={{ color: 'white', textDecoration: 'none', '&:hover': { textDecoration: 'underline' } }}>Contact us</Link></Typography>
            <Typography variant='body1' sx={{fontSize:{xs:'14px',sm:'16px'}}} ><Link href="/Terms&Conditions" sx={{ color: 'white', textDecoration: 'none', '&:hover': { textDecoration: 'underline' } }}>Terms&Conditions</Link></Typography>
          </Box>
        </Grid>
