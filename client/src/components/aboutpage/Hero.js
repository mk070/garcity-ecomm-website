  ...
  return (
        ...
        marginTop:isSmallScreen?'100px':'140px'}}>
            ...
            <source src = {gif} type = "video/webm"/>
                ...
                <img src={hero} alt="" height={'80%'} width={'100%'} style={{ objectFit:'cover',boxShadow:"black 1px 1px 8px 0px",borderRadius:'35px'}} srcset="" />
            </Box>
            ...
            <Box sx={{
                ...
                >                   
                    ‘Make your own <br/> clothing style with<span style={{ color: 'var(--trinary-color)', fontWeight:500,  fontFamily: "var(--primary-font)  !important" }}> Garcity</span>‘</Typography>
