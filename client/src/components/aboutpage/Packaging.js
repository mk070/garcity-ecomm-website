...
const Packaging = () => {
  ...
  return (
    <Container maxWidth="xl" position='sticky' sx={{ top: 80,height:{sm:'75vh'} ,backgroundColor:"white",marginTop: { xs: '10px' }, display: 'flex', flexDirection: { xs: 'column', sm: 'row-reverse' }, justifyContent: 'center', alignItems: 'center', gap: '100px' }}>
      ...
      <Box>
        ...
        Elevate your brand with sustainable packaging solutions that
        reflect your values. Choose eco-friendly options to enhance your brand identity and
