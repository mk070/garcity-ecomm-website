...
export const Dashboard = () => {
  ...
  const [showClientLogo, setshowClientLogo] = React.useState(false);
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, display: 'flex' }}>
        {/* Sidebar */}
        <Sidebar setShowGallery={setShowGallery} setshowPopularWork={setshowPopularWork} setshowYoutube={setshowYoutube} setshowClientLogo={setshowClientLogo} />
        ...
        <Box sx={{ flexGrow: 1, backgroundColor: '#f0f0f0' }}>
          <Appbar />
            ...
            {showClientLogo && <ManageClientLogos />}
            {!showGallery && !showPopularWork && !showYoutube && !showClientLogo && (
