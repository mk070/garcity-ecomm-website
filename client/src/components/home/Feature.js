  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box ref={featureRef} sx={{ width: { sm: '60%' }, display: 'flex', pt: '30px', flexDirection: 'column', ml: '120px' }}>
          <Typography variant="h4" sx={{ fontSize: { sm: '32px' } , fontFamily: "integral-Regular  !important"  }} color marginBottom={''}>
            Why Garcity ?
          </Typography>
          <Box sx={{ mt: { sm: '30px' } }}>
            <Typography className="point" sx={{ fontSize: { sm: '18px' }, lineHeight: { sm: '30px' }, mb: { sm: '10px' } }}>
