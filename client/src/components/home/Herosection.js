...
import img1Small from '../../assets/images/Home/banner/img1-small.avif';
      ...
      >
        <SwiperSlide>
          ...
          <Box sx={{ position: 'relative',objectFit:"contain" }}>
            ...
            <LazyLoadImage src={img1} sx={{ width: '100%' }} PlaceholderSrc={img1Small} alt="Image Alt" loading='lazy' effect='blur'/>
